      ...
      <React.Fragment>
        <div className="bg-light p-4">
          ...
          <div className="d-flex px-2 my-4">
            ...
            <span className="ml-auto">Ksh {parseFloat(subtotal).toFixed(2)}</span>
          </div>
          <hr />
          <div className="d-flex px-2 my-4">
            <span>Shipping</span>
            <span className="ml-auto">
              {shippingNumeric > 0 ? (
                `Ksh ${parseFloat(shippingNumeric).toFixed(2)}`
              ) : (
                <strong>FREE</strong>
              )}
            </span>
          ...
          <div className="d-flex px-2 my-4">
            <span>Tax (20%)</span>
            <span className="ml-auto">Ksh {parseFloat(afterTax).toFixed(2)}</span>
          </div>
          <hr />
          <div className="d-flex px-2 my-4">
            <span>Total</span>
